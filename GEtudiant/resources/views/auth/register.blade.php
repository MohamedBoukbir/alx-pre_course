            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="dateNaissane" class="col-md-4 col-form-label text-md-end">{{ __('DateNaissane') }}</label>

                            <div class="col-md-6">
                                <input id="dateNaissane" type="date" class="form-control @error('dateNaissane') is-invalid @enderror" name="dateNaissane" value="{{ old('dateNaissane') }}" required >
                        ...
                        <div class="row mb-3">
                            <label for="filiere" class="col-md-4 col-form-label text-md-end">{{ __('Filiere') }}</label>
                            ...
                            <select name="filiere" id="filiere" class="form-select"> 
                                ...
                                <option value="Genie Matimatique">Genie Matimatique</option>
                            </select>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('Mote de pass') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Confirm mote de pass') }}</label>
